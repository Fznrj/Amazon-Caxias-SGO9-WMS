...
const OutboundView: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-[100dvh] animate-in fade-in duration-500">
      ...
      <div className="flex-1 overflow-y-auto min-h-0 space-y-6 pb-20 md:pb-6 pr-1">
        ...
        {/* Rodapé Informativo */}
        <div className="bg-slate-50 dark:bg-slate-900/30 p-4 rounded-lg flex items-center gap-3 text-slate-500 mt-6">
